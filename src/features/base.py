...
class GenericFeatureOperation(AbstractFeatureOperation, FeatureTimingMixin):
    ...
    def generate_features(self, df: pd.DataFrame, auto_register: bool = True, origin: str = 'generic', **kwargs) -> Dict[str, pd.Series]:
        ...
        try:
            ...
            if self._auto_registration_enabled and features and auto_register:
                self._auto_register_operation_metadata(features, origin=origin, **kwargs)
    ...
    def _auto_register_operation_metadata(self, features: Dict[str, pd.Series], origin: str = 'generic', **kwargs):
        """
...
class CustomFeatureOperation(AbstractFeatureOperation, FeatureTimingMixin):
    ...
    def generate_features(self, df: pd.DataFrame, auto_register: bool = True, origin: str = 'custom', **kwargs) -> Dict[str, pd.Series]:
        """Generate features with timing and optional auto-registration.
        ...
        try:
            ...
            # Auto-register operation and features if enabled and requested
            if self._auto_registration_enabled and features and auto_register:
                self._auto_register_custom_operation_metadata(features, origin=origin, **kwargs)
