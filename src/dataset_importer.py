...
class DatasetImporter:
    ...
    def create_duckdb_dataset(self, file_mappings: Dict[str, str], 
        ...
        try:
            ...
            # Train features are already registered in dataset DB above
            # No need to register in main DB to avoid duplication
            logger.info(f"✅ Original dataset features registered in dataset database")
